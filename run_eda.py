...
yaml_file_path = r'C:\Users\Graphic-Era\Jupyter Projects\Vision_data_EDA-main\Vision_data_EDA-main\data\data.yaml'
with open(yaml_file_path, 'r') as f:
    data_yaml = yaml.safe_load(f)

dataset_params = {
    'data_dir': r'C:\Users\Graphic-Era\Jupyter Projects\Vision_data_EDA-main\Vision_data_EDA-main\data',
